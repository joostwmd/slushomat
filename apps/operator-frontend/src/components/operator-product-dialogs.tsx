...
export function OperatorProductUploadFailureDialog({
  open,
  onOpenChange,
  productLabel,
  errorMessage,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton={!pending} className="max-w-md">
        ...
        <p className="text-xs text-muted-foreground">
          You can retry the upload, keep the product without an image, or delete
          the product.
        </p>
...
export function DeleteOperatorProductDialog({
  open,
  onOpenChange,
  name,
  onConfirm,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton={!pending} className="max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            <strong>{name}</strong> will be removed from this organization. This
            cannot be undone.
          </DialogDescription>
        </DialogHeader>
...
export function ReplaceOperatorProductImageDialog({
  open,
  onOpenChange,
  onConfirm,
  pending,
